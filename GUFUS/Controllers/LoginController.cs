...
namespace GUFUS.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        // ~ Define uma variável para percorrer nossos métodos com as configurações do appS
        private IConfiguration _config;

        // ~ Definimos um método construtor para validar as informações do appSetting.js
        ...
        {   
            // ~ Cria uma variável do tipo ICtionResult que por padrão é NÃO autorizado
            ...
            if(Usuario != null)
            {
                ...
                // ~ Define que  resposta será 200 OK e retornará um objeto chamado token com o token
        ...
        {
            // ~ Declara uma variável que busca no nosso banco de dados um usuário que tenha o email e a senha presente no banco de dados
